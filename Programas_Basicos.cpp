...
int main()
{
     int m,opcion;	
        ...
        cout << "17. Muestre Algoritmo de Euclides" << endl;
        cout << "18. Calcular El Area de un triangulo" << endl;
        cout << "19. Mostrar numeros pares hasta 30 " << endl;
        cout << "20. Muestre MRU de un problema" << endl;
        cout << "21. SALIR" << endl;
   ...
   case 10:cout<<">>Crear de forma grafica la multiplicacion manual<<"<<endl;
    ...
    case 17:cout<<">>Muestre Algoritmo de Euclides<<"<<endl;
     {
     float num1 = 60;
     float num2 = 30; 
     while (num2 != 0) {
        float temp = num2;
        num2 = std::fmod(num1, num2);
        num1 = temp;
     }
     std::cout << "El MCD de " << num1 << " y " << num2 << " es: " << num1 << std::endl;
     return 0;
	 }
	 
    case 18:cout<<">>Calcular El Area de un triangulo<<"<<endl;
     {
     float base = 4.5;
     float altura = 3.2;
	...
	case 19:cout<<">>Mostrar numeros pares hasta 30<<"<<endl;
	 {
     float i = 0.0;
     while (i <= 30.0) {
        if (fmod(i, 2.0) == 0.0) {
    ...
    case 20:cout<<">>Muestre MRU de un problema<<"<<endl;
     {
     float velocidad = 305.5;
     float tiempo = 100.0;
     float distancia = velocidad * tiempo;
     cout << "Un objeto que se mueve a " << velocidad << " metros por segundo " <<
            "durante " << tiempo << " segundos, recorre una distancia de " <<
            distancia << " metros." << endl;
     return 0;
	 }
